...
gulp.task("htmlmin", function() {
    ...
    return gulp.src("test/src/index.html").pipe(yasuohtml(options)).pipe(gulp.dest("test/dist"));
...
gulp.task("cssmin",function(){
    return gulp.src("test/src/css/*").pipe(yasuocss()).pipe(gulp.dest("test/dist/css"));
})
...
gulp.task("jsmin",function(){
    return gulp.src("test/src/js/*").pipe(babel({
        "presets" : ["es2015"]
    })).pipe(yasuojs()).pipe(gulp.dest("test/dist/js"));
})